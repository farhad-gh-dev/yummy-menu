...
const fakeData_two = {
  ...
  restaurantMenu: [
    {
      _id: { $oid: "601ae91d264f601888190622" },
      title: "`double steakhouse`",
      description:
    ...
    {
      _id: { $oid: "601ae91d264f601888190623" },
      title: "`double bacon`",
      description:
    ...
    {
      _id: { $oid: "601ae91d264f601888190624" },
      title: "`plant-base whopper`",
      description:
    ...
    {
      _id: { $oid: "601ae91d264f601888190625" },
      title: "`hamburger`",
      description:
    ...
    {
      _id: { $oid: "601ae91d264f601888190626" },
      title: "`cheese lover chicken`",
      description:
    ...
    {
      _id: { $oid: "601ae91d264f601888190627" },
      title: "`long chicken`",
      description:
    ...
    {
      _id: { $oid: "601ae91d264f601888190628" },
      title: "`crunchy chicken deluxe`",
      description:
    ...
    {
      _id: { $oid: "601ae91d264f601888190629" },
      title: "`crispy chicken`",
      description:
    ...
    {
      _id: { $oid: "601ae91d264f60188819062a" },
      title: "`BBQ mixed grill`",
      description:
    ...
    {
      _id: { $oid: "601ae91d264f60188819062b" },
      title: "`Vegan Shawarma`",
      description:
    ...
    {
      _id: { $oid: "601ae91d264f60188819062c" },
      title: "`Hot Chicken`",
      description:
    ...
    {
      _id: { $oid: "601ae91d264f60188819062d" },
      title: "`hot thai chicken`",
      description:
    ...
    {
      _id: { $oid: "601ae91d264f60188819062e" },
      title: "`Brooklyn Style`",
      description:
    ...
    {
      _id: { $oid: "601ae91d264f60188819062f" },
      title: "`Pepperoni Perfection`",
      description:
    ...
    {
      _id: { $oid: "601ae91d264f601888190630" },
      title: "`New York`",
      description:
    ...
    {
      _id: { $oid: "601ae91d264f601888190631" },
      title: "`Caffee Americano`",
      description:
    ...
    {
      _id: { $oid: "601ae91d264f601888190632" },
      title: "`Espresso`",
      description:
    ...
    {
      _id: { $oid: "601ae91d264f601888190633" },
      title: "`Hot Chocolate`",
      description:
    ...
    {
      _id: { $oid: "601ae91d264f601888190634" },
      title: "`Green Tea`",
      description:
    ...
    {
      _id: { $oid: "601ae91d264f601888190635" },
      title: "`Iced Caffè Americano`",
      description:
    ...
    {
      _id: { $oid: "601ae91d264f601888190636" },
      title: "`Iced Espresso`",
      description:
    ...
    {
      _id: { $oid: "601ae91d264f601888190637" },
      title: "`Lemonade`",
      description:
    ...
    {
      _id: { $oid: "601ae91d264f601888190638" },
      title: "`Iced Pineapple Matcha`",
      description:
